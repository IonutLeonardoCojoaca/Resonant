...
class CreatePlaylistFragment : BaseFragment(R.layout.fragment_create_playlist) {
    ...
    fun updateSelection(selected: Int) {
        ...
        if (selected == 1) {
            layoutOption1.setBackgroundResource(R.drawable.selector_playlist_public)
            (layoutOption1.background as? TransitionDrawable)?.startTransition(200)

            layoutOption2.setBackgroundResource(R.drawable.selector_playlist_private)
            (layoutOption2.background as? TransitionDrawable)?.startTransition(200)

            publicIconCheck.setImageResource(R.drawable.ic_public_selected)
            privateIconCheck.setImageResource(R.drawable.ic_private)
        } else {
            layoutOption1.setBackgroundResource(R.drawable.selector_playlist_private)
            (layoutOption1.background as? TransitionDrawable)?.startTransition(200)

            layoutOption2.setBackgroundResource(R.drawable.selector_playlist_public)
            (layoutOption2.background as? TransitionDrawable)?.startTransition(200)

            publicIconCheck.setImageResource(R.drawable.ic_public)
            privateIconCheck.setImageResource(R.drawable.ic_private_selected)
        }
