package com.example.resonant.updates
...
import com.example.resonant.ApiResonantService
import com.example.resonant.AppUpdate
import com.example.resonant.UpdateDecision
import com.example.resonant.Utils
import com.example.resonant.VersionProvider
...
class AppUpdateManager(
    ...
    suspend fun checkForUpdate(): UpdateDecision = withContext(Dispatchers.IO) {
        try {
            ...
            Log.d("AppUpdate", "Current=$current, Latest=$latestV, cmp=$cmp, force=${latest.forceUpdate}")
